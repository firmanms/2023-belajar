           ...
           <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    @endif
                        ...
                        <form action="{{ route('artikel.update',$artikel->id) }}" method="POST" enctype="multipart/form-data" class="w-full max-w-lg" >
                            @csrf
                            @method('PUT')
                        <div class="flex flex-wrap -mx-3 mb-3">
                          <div class="w-full md:w-1/2 px-3 mb-3 md:mb-0">
                            ...
                            <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" name="judul" id="grid-first-name" type="text" placeholder="Judul Artikel" value="{{ $artikel->judul }}">
                            @error('judul')
                        ...
                        <div class="flex flex-wrap -mx-3 mb-3">
                          <div class="w-full px-3">
                            ...
                            <textarea name="isi" class="form-control" name="summernote" id="summernote"> {{ $artikel->isi }}</textarea>
                            @error('isi')
                            <p class="text-red-500 text-xs italic">{{ $message }}</p>
                            @enderror
                          </div>
